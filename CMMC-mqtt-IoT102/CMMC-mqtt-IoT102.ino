...
//const char* DEVICENAME = "MQTTester";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect(DEVICENAME, MQTT_PREFIX, 2, true, "I'm die")) {
      Serial.println("connected");
      // Once connected, publish an announcement...
      client.publish("/hello/mqtt", "hello world");
      // ... and resubscribe
      client.subscribe("/hello/mqtt/command");
    } else {
